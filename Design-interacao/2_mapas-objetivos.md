...
> Acesso com suporte de acessibilidade: leitura de campos, feedback vibratório e comandos de voz.

## 🟧 AA | Seguir Treino do Dia

> Acesso assistido com descrição sonora, vibração ao finalizar, leitura automática e instruções adaptadas.

## 🟧 AA | Acessar Vídeos e Instruções

> Versão adaptada com descrição de elementos visuais, instruções narradas e mídia acessível.

## 🟧 AA | Registrar Execução

> Registro simplificado por voz, vibração de confirmação e leitura de campos.

## 🟧 AA | Acompanhar Evolução

> Evolução em formato narrado, leitura de gráficos, listas acessíveis e comparações por voz.

## 🟧 AA | Comunicação

> Troca de mensagens por áudio, leitura automática e organização adaptada.

## 🟧 AA | Notificações e Consistência

> Notificações com leitura automática, sinais sonoros e vibração.
